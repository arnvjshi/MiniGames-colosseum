...
function loadQuestion() {
  ...
  correctIndexInRandomized = shuffledOptions.indexOf(
...
// Expose checkAnswer to the global scope for inline event handlers
window.checkAnswer = checkAnswer;

// Export functions for module usage
export { updateGameData, startGame, checkAnswer, gameOver, resetGame };
